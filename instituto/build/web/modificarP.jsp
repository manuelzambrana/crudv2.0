...
.no-background {
  ...
  <body>
    <%
      ...
      String actualizacion = "UPDATE profesor SET "
                           + "nombre='" + request.getParameter("nombre")
                           + "', edad=" + Integer.valueOf(request.getParameter("edad"))
                           + ", asignatura='" + request.getParameter("asignatura")                          
                           + "' WHERE profesor_id=" + Integer.valueOf(request.getParameter("profesor_id"));
          ...
          <div class="col-sm-10" style="width: 700px; margin-left: 250px; margin-top: 50px;">
              <div class="jumbotron" style="background-color:transparent !important;">
                  ...
                  <form class="form-horizontal" style="margin-left: 50px ">
                      ...
                      <a href="profesor.jsp" class="btn btn-primary" style="margin-left: 100px;"><span class="glyphicon glyphicon-ok" ></span> Listado profesores</button></a>
